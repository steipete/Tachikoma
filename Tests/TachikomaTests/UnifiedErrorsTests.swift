...
struct UnifiedErrorsTests {
    ...
    func testUnifiedErrorWithRecovery() throws {
    ...
    func testLegacyErrorConversion() throws {
    ...
    func testModelErrorConversion() throws {
    ...
    func testAgentToolErrorConversion() throws {
    ...
    func testErrorCodeCategories() throws {
    ...
    func testGenericErrorConversion() throws {
    ...
    func testAPICallErrorConversion() throws {
    ...
    func testRetryErrorConversion() throws {
    ...
    func testErrorWithoutRecovery() throws {
        let error = TachikomaUnifiedError(
