//
//  MultiChannelResponseTests.swift
//  Tachikoma
//
...
struct MultiChannelResponseTests {
    ...
    func testResponseChannelRawValues() {
    ...
    func testLegacyMessageCompatibility() {
        // Old API still works
    ...
    func testChannelAwareMessageCreation() {
    ...
    func testResponseChannelCodable() throws {
