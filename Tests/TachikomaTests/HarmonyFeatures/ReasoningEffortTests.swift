...
struct ReasoningEffortTests {
    ...
    func testGenerationSettingsReasoningEffort() {
    ...
    func testGenerationSettingsDefaultReasoningEffort() {
        let settings = GenerationSettings.default
        #expect(settings.reasoningEffort == nil)
    }
    
    @Test("RetryHandler adapts based on reasoning effort")
    func testRetryHandlerReasoningEffortAdaptation() {
    ...
    func testGenerationSettingsCodableWithReasoningEffort() throws {
        let encoder = JSONEncoder()
    ...
    func testGenerationSettingsCodableWithoutReasoningEffort() throws {
        let encoder = JSONEncoder()
        let decoder = JSONDecoder()
    ...
    func testReasoningEffortOrdering() {
