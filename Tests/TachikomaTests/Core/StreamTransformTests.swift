...
struct StreamTransformTests {
    ...
    func testBufferTransform() async throws {
    ...
    func testBufferTransformWithInterval() async throws {
    ...
    func testThrottleTransform() async throws {
    ...
    func testTapTransform() async throws {
    ...
    func testStreamFilterExtension() async throws {
    ...
    func testStreamMapExtension() async throws {
        let stream = AsyncThrowingStream<Int, Error> { continuation in
            Task {
                for i in 1...3 {
                    continuation.yield(i)
    ...
    func testStreamTapExtension() async throws {
        actor TapCollector {
            var values: [String] = []
    ...
    func testStreamBufferExtension() async throws {
        let stream = AsyncThrowingStream<Int, Error> { continuation in
            Task {
                for i in 1...7 {
                    continuation.yield(i)
    ...
    func testStreamThrottleExtension() async throws {
        let stream = AsyncThrowingStream<Int, Error> { continuation in
            Task {
                for i in 1...5 {
                    continuation.yield(i)
    ...
    func testStreamTextResultFilter() async throws {
    ...
    func testStreamTextResultCollectText() async throws {
        let stream = AsyncThrowingStream<TextStreamDelta, Error> { continuation in
            Task {
                continuation.yield(TextStreamDelta(type: .textDelta, content: "Hello"))
    ...
    func testStreamTextResultFullText() async throws {
        let stream = AsyncThrowingStream<TextStreamDelta, Error> { continuation in
            Task {
    ...
    func testCombinedTransform() async throws {
    ...
    func testComplexTransformPipeline() async throws {
        let stream = AsyncThrowingStream<Int, Error> { continuation in
            Task {
                for i in 1...10 {
                    continuation.yield(i)
