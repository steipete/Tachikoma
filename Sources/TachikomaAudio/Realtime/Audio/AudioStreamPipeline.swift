...
extension AudioStreamPipelineDelegate {
    ...
    public func audioStreamPipeline(didProcessInput data: Data) async {}
    public func audioStreamPipeline(didProcessOutput data: Data) async {}
    public func audioStreamPipeline(didDetectVoice: Bool) async {}
