...
public struct AgentTool: Sendable {
    ...
    public init(
        ...
        self.execute = { args, _ in try await execute(args) }
    }
    ...
    public func execute(_ arguments: AgentToolArguments, context: ToolExecutionContext) async throws -> AnyAgentToolValue {
