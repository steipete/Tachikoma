...
// MARK: - Enhanced Response Cache

/// Advanced cache with TTL, memory management, and invalidation strategies
@available(macOS 13.0, iOS 16.0, watchOS 9.0, tvOS 16.0, *)
public actor EnhancedResponseCache {
    // MARK: - Properties
...
public struct CacheAwareProvider<Base: ModelProvider>: ModelProvider {
    let provider: Base
    let cache: EnhancedResponseCache
